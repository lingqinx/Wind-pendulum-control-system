...
extern void DMA_PORTx2BUFF_PeriInit(DMA_CHn,void * SADDR,void * DADDR, PTxn,DMA_BYTEn,u32 ,DMA_PORTx2BUFF_cfg);


extern void DMA_setDAddress(DMA_CHn CHn,void * DADDR);

#define  DMA_SETDAADDR(CHn,DADDR)   DMA_DADDR(CHn) =    (u32)DADDR
