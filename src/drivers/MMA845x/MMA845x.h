...
#define MMA845x_READ_BYTE(address)          I2C_ReadAddr(MMA845xI2C,MMA845x_IIC_ADDRESS,address)

#define MMA845x_WRITE_BYTE(address,thedata) I2C_WriteAddr(MMA845xI2C,MMA845x_IIC_ADDRESS,address,thedata)
...
/*
#define Get845xX_8bit                       MMA845x_readbyte(OUT_X_MSB_REG); 
#define Get845xX_10bit                      MMA845x_readbyte(OUT_X_MSB_REG); 
#define Get845xX_12bit                      MMA845x_readbyte(OUT_X_MSB_REG); 
#define Get845xX_14bit                      MMA845x_readbyte(OUT_X_MSB_REG); 
*/
