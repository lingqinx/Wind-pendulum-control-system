...
#undef  VECTOR_061                        //要先取消了
#define VECTOR_061    UART0_IRQHandler   //重新定义61号中断的ISR：UART0：Single interrupt vector for UART status sources
extern void UART0_IRQHandler();          //串口0 中断接收函数
