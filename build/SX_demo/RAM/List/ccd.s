...
//    Cpu mode     =  thumb                                                   /
//    Endian       =  little                                                  /
//    Source file  =  D:\workspace\myworkspace\SW_K60\src\drivers\ccd\ccd.c   /
//    Command line =  D:\workspace\myworkspace\SW_K60\src\drivers\ccd\ccd.c   /
...
// D:\workspace\myworkspace\SW_K60\src\drivers\ccd\ccd.c
//    1 /*
//    2 ************************************************************************
//    3 *                北京邮电大学 K60 学习例程                                        
//    4 * 文件名 :[ccd.c] 
...
GetPhoto:
        ...
        STR      R1,[R0, #+0]
//  173     Clr_CCDF;
        LDR.W    R0,??DataTable8_14  ;; 0x40039050
        LDR      R0,[R0, #+0]
        LSRS     R0,R0,#+1
        LSLS     R0,R0,#+1
        LDR.W    R1,??DataTable8_14  ;; 0x40039050
        STR      R0,[R1, #+0]
        LDR.W    R0,??DataTable8_14  ;; 0x40039050
        LDR      R0,[R0, #+0]
        BICS     R0,R0,#0x2
...
//  452     {
//  453         printp("%3d",i); 
//  454         printp("-%3d-%3d-%3d",templineL[i],templine[i],templineR[i]);  
//  455         
