///////////////////////////////////////////////////////////////////////////////
//                                                                            /
// IAR ANSI C/C++ Compiler V6.60.1.5097/W32 for ARM     15/Aug/2015  12:46:23 /
...
//                    FTM\FTM.c -lCN C:\Users\Administrator\Desktop\MPU60508. /
...
// C:\Users\Administrator\Desktop\MPU60508.12\src\drivers\FTM\FTM.c
//    1 /*
//    2 ************************************************************************
//    3 *                北京邮电大学 K60 学习例程                                        
//    4 * 文件名 :[FTM.c] 
...
//  860             SIM_SCGC5 |= SIM_SCGC5_PORTA_MASK;
        ...
        STR      R0,[R1, #+0]
//  861             PORT_PCR_REG(PORTA_BASE_PTR, 12) = (0|PORT_PCR_MUX(7)|0x10);  // PTA12 //依米使用
        LDR.N    R0,??DataTable8_15  ;; 0x40049030
        MOV      R1,#+1808
        STR      R1,[R0, #+0]
//  862             PORT_PCR_REG(PORTA_BASE_PTR, 13) = (0|PORT_PCR_MUX(7)|0x13);  // PTA13 //依米使用
...
//  889             SIM_SCGC5 |= SIM_SCGC5_PORTB_MASK;
        ...
        LDR.N    R1,??DataTable8_6  ;; 0x40048038
        STR      R0,[R1, #+0]
//  890             PORT_PCR_REG(PORTB_BASE_PTR, 18) = (0|PORT_PCR_MUX(6)|0x10);  // PTB18 //依米使用
        LDR.N    R0,??DataTable8_17  ;; 0x4004a048
        MOV      R1,#+1552
        STR      R1,[R0, #+0]
//  891             PORT_PCR_REG(PORTB_BASE_PTR, 19) = (0|PORT_PCR_MUX(6)|0x13);  // PTB19 //依米使用
...
//  903     FTM_CNTIN_REG(FTMx[ftmn])    = 0;                             //FTM计数器初始值为0
        ...
        MOVS     R1,#+0
        STR      R1,[R0, #+76]
//  904     FTM_MOD_REG(FTMx[ftmn])      = 0xFFFF;                        //FTM计数器结束值为0xFFFF
        UXTB     R4,R4            ;; ZeroExt  R4,R4,#+24,#+24
        LDR.N    R0,??DataTable8_5
        LDR      R0,[R0, R4, LSL #+2]
        MOVW     R1,#+65535
...
//  909     
//  910      
//  911     FTM_QDCTRL_REG(FTMx[ftmn])  |=FTM_QDCTRL_QUADEN_MASK;         //使能FTMx正交解码模式
        UXTB     R4,R4            ;; ZeroExt  R4,R4,#+24,#+24
        LDR.N    R0,??DataTable8_5
        LDR      R0,[R0, R4, LSL #+2]
        LDR      R0,[R0, #+128]
        ...
        LDR      R1,[R1, R4, LSL #+2]
        STR      R0,[R1, #+128]
//  912     FTM_MODE_REG(FTMx[ftmn])    |= FTM_MODE_FTMEN_MASK;           //FTMxEN=1	
        UXTB     R4,R4            ;; ZeroExt  R4,R4,#+24,#+24
        LDR.N    R0,??DataTable8_5
        LDR      R0,[R0, R4, LSL #+2]
        LDR      R0,[R0, #+84]
...
`?<Constant "C:\\\\Users\\\\Administrato...">`:
        ...
        DC8 54H, 4DH, 5CH, 46H, 54H, 4DH, 2EH, 63H
        DC8 0
        DC8 0, 0, 0
