...
//    Cpu mode     =  thumb                                                   /
//    Endian       =  little                                                  /
//    Source file  =  C:\Users\Administrator\Desktop\MPU60508.12\src\cpu\star /
//                    t.c                                                     /
//    Command line =  C:\Users\Administrator\Desktop\MPU60508.12\src\cpu\star /
//                    t.c -lCN C:\Users\Administrator\Desktop\MPU60508.12\bui /
//                    ld\gpio_demo\FLASH\List\ -lB                            /
...
// C:\Users\Administrator\Desktop\MPU60508.12\src\cpu\start.c
//    1 /*
//    2  * File:	start.c
...
//   36     uartPrintf("\n\n********************************************************\n");
        ...
        BL       uartPrintf
//   37     uartPrintf("* \t\t BUPT K60 *\n");
        LDR.W    R0,??DataTable2_2
        BL       uartPrintf
//   38     uartPrintf("* Core Freq: %3dMHz \tBus Freq: %3dMHz              *\n",\ 
//   39            core_clk_mhz,core_clk_mhz/(mcg_div.bus_div+1));
        ...
        BL       uartPrintf
//   40     uartPrintf("* flex Freq: %3dMHz \tflash Freq: %3dMHz              *\n",\ 
...
//   82 
//   83     /* 跳进main函数 */
//   84     uartPrintf("* Designed By: snowwolf    Modified By: feichashao *\n");  
??start_10:
        LDR.W    R0,??DataTable2_24
        BL       uartPrintf
//   85     uartPrintf("* Latest Update: ");  
...
??DataTable2_4:
        ...
        DATA
??DataTable2_5:
        DC32     `?<Constant "* Core Freq: %3dMHz \\t...">`

        SECTION `.text`:CODE:NOROOT(2)
        SECTION_TYPE SHT_PROGBITS, 0
        DATA
??DataTable2_6:
        DC32     `?<Constant "* flex Freq: %3dMHz \\t...">`

        SECTION `.text`:CODE:NOROOT(2)
        SECTION_TYPE SHT_PROGBITS, 0
        DATA
??DataTable2_7:
        DC32     `?<Constant "* Started by:">`
...
??DataTable2_23:
        ...
        DATA
??DataTable2_24:
        DC32     `?<Constant "* Designed By: snowwo...">`

        SECTION `.text`:CODE:NOROOT(2)
        SECTION_TYPE SHT_PROGBITS, 0
        DATA
??DataTable2_25:
        DC32     `?<Constant "* Latest Update: ">`

        SECTION `.text`:CODE:NOROOT(2)
        SECTION_TYPE SHT_PROGBITS, 0
        DATA
??DataTable2_26:
        DC32     `?<Constant "12:46:34">`

        SECTION `.text`:CODE:NOROOT(2)
        SECTION_TYPE SHT_PROGBITS, 0
        DATA
??DataTable2_27:
        DC32     `?<Constant "Aug 15 2015">`
...
`?<Constant "* \\t\\t BUPT K60 *\\n">`:
        ...
        SECTION `.rodata`:CONST:REORDER:NOROOT(2)
`?<Constant "* Core Freq: %3dMHz \\t...">`:
        DATA
        DC8 2AH, 20H, 43H, 6FH, 72H, 65H, 20H, 46H
        DC8 72H, 65H, 71H, 3AH, 20H, 25H, 33H, 64H
        DC8 4DH, 48H, 7AH, 20H, 9, 42H, 75H, 73H
        DC8 20H, 46H, 72H, 65H, 71H, 3AH, 20H, 25H
        ...
        SECTION `.rodata`:CONST:REORDER:NOROOT(2)
`?<Constant "* flex Freq: %3dMHz \\t...">`:
        DATA
        DC8 2AH, 20H, 66H, 6CH, 65H, 78H, 20H, 46H
        DC8 72H, 65H, 71H, 3AH, 20H, 25H, 33H, 64H
        DC8 4DH, 48H, 7AH, 20H, 9, 66H, 6CH, 61H
        DC8 73H, 68H, 20H, 46H, 72H, 65H, 71H, 3AH
        DC8 20H, 25H, 33H, 64H, 4DH, 48H, 7AH, 20H
        DC8 20H, 20H, 20H, 20H, 20H, 20H, 20H, 20H
        DC8 20H, 20H, 20H, 20H, 20H, 2AH, 0AH, 0
...
`?<Constant "SRAM                 ...">`:
        ...
        SECTION `.rodata`:CONST:REORDER:NOROOT(2)
`?<Constant "* Designed By: snowwo...">`:
        DATA
        DC8 2AH, 20H, 44H, 65H, 73H, 69H, 67H, 6EH
        DC8 65H, 64H, 20H, 42H, 79H, 3AH, 20H, 73H
        DC8 6EH, 6FH, 77H, 77H, 6FH, 6CH, 66H, 20H
        DC8 20H, 20H, 20H, 4DH, 6FH, 64H, 69H, 66H
        DC8 69H, 65H, 64H, 20H, 42H, 79H, 3AH, 20H
        DC8 66H, 65H, 69H, 63H, 68H, 61H, 73H, 68H
        DC8 61H, 6FH, 20H, 2AH, 0AH, 0
        DC8 0, 0

        SECTION `.rodata`:CONST:REORDER:NOROOT(2)
`?<Constant "* Latest Update: ">`:
        DATA
        DC8 "* Latest Update: "
        DC8 0, 0
...
//  336 
// 
// 1 650 bytes in section .rodata
// 1 428 bytes in section .text
// 
// 1 428 bytes of CODE  memory
// 1 650 bytes of CONST memory
//
//Errors: none
//Warnings: none
